...
let entryEditFormRow (entry: Entry) =
    let (entryId, date, start, endTimeOpt, usdRate, fxRate) =
        ...
        | Closed c -> 
            (c.Id, c.Date, c.Start, Some c.End, c.UsdRate, c.FxCadPerUsd)
    ...
    tr [] [
        td [ _colspan "8" ] [
            form [ 
                ...
                div [ _style "display: flex; gap: 10px; align-items: end;" ] [
                    div [ _class "form-group"; _style "margin: 0;" ] [
                    ...
                    div [ _class "form-group"; _style "margin: 0;" ] [
                        ...
                        input [ _type "number"; _name "usdRate"; _step "0.01"; _min "0"; 
                                _value (string (stripRate usdRate)); _required ]
                    ]
                    
                    div [ _class "form-group"; _style "margin: 0;" ] [
                        label [ _for "fxRate" ] [ str "FX Rate" ]
                        input [ _type "number"; _name "fxRate"; _step "0.0001"; _min "0"; 
                                _value (string (stripFx fxRate)); _required ]
                    ]
